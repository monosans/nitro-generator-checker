...
This is the easiest way, but it is only available for x86_64 Windows, x86_64/arm64 macOS and x86_64 Linux. Just download the archive for your OS from [nightly.link](https://nightly.link/monosans/nitro-generator-checker/workflows/ci/main?preview), unzip it, edit `config.toml` and run the executable.
